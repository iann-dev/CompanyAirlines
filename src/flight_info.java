...
public class flight_info extends FlightManagementSystem{
    ...
    public flight_info(){
        ...
        JLabel FlightDetails = new JLabel("INFORMAÇÃO DE VÔO");
        ...
        JLabel Empid = new JLabel("ID FUNCIONARIO");
        ...
        JLabel FlightCode = new JLabel("CODIGO DE VÔO");
        ...
        JLabel FlightName = new JLabel("DATA");
        ...
        JLabel Source = new JLabel("PARTIDA");
